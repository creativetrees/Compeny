        ...
        SiteSetting::updateOrCreate(['id' => 1], [
            ...
            'page_content' => [
                ...
                'pricing' => [
                    ...
                    'faq_intro' => 'The questions we hear most, answered straight — before you ever send a brief.',
                ],
                'process' => [
                    ...
                    'sequence_intro' => 'Four phases in one continuous flow — each closing the riskiest gaps before the next begins.',
                    'phases_label' => 'phases',
                ...
                'about' => [
                    ...
                    'values_intro' => 'The handful of beliefs that shape how we design, build, and decide.',
                    'team_eyebrow' => 'The team',
                    'team_title' => 'Senior, embedded, accountable.',
                    'team_intro' => 'Senior strategists, designers, and engineers who embed with your team and stay accountable end to end.',
                    'team_link' => 'Meet everyone',
                    'clients_eyebrow' => 'In good company',
                    'clients_intro' => "A few of the teams we've designed and built alongside.",
                ],
                'contact' => [
